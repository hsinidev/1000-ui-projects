...
def inject_seo(html_path, project_name):
    try:
        ...
        # Remove personal phone number if it exists anywhere in the doc (safety scrub)
        html = html.replace('+212658029773', '')
    ...
    """
        ...
        # Finally, re-inject using string replace
        if '</body>' in html:
...
def process_all_portals():
    ...
    for folder in project_folders:
        ...
        print(f"Branding Updated (v32 - Removed Phone): {folder}")
